!function (e) {
    ...
    function t() {
        e(".awe-masonry").each(function () {
            var a = e(this), t = a.children(".awe-masonry__item");
            setTimeout(function () {
                a.masonry({columnWidth: ".awe-masonry__item:first-child", itemSelector: ".awe-masonry__item"})
    ...
    function r(a) {
        var t = e(".product-slider-thumb").data("owlCarousel").owl.visibleItems, i = a, n = !1;
        for (var o in t)if (i == t[o])var n = !0;
    ...
    function l() {
        e(".price-slider").each(function () {
            var a = e(this);
            a.slider({
                min: 0, max: 1e4, step: 5, values: [0, 1e4], range: !0, slide: function (t, i) {
    ...
    function d() {
        e(".tabs").tabs({active: 0, show: {effect: "fade", duration: 200}, hide: {effect: "fade", duration: 200}})
    }

    function p() {
        e(".accordion").accordion({collapsible: !0, heightStyle: "content", animate: 200})
    }

    function g() {
        var a = e(".travelling-tabs__time").find(".season"), t = a.find(".item"), i = e(".travelling-tabs__time").find(".month"), n = i.find(".item");
        t.each(function () {
            var a = e(this);
            a.hover(function () {
    ...
    function h() {
        e(".awe-services").length > 0 && e(".awe-services").parent().theiaStickySidebar({updateSidebarHeight: !0}), e(".detail-sidebar").length > 0 && e(".detail-sidebar").parent().theiaStickySidebar({
            ...
            callbacks: {
                ajaxContentAdded: function () {
                    ...
                    e(".flight-popup__slider").owlCarousel({
                        ...
                        var a = e(this);
                        a.perfectScrollbar({maxScrollbarLength: 150, wheelSpeed: .5}), a.perfectScrollbar("update")
                    }), e(".tabs").tabs({
                        active: 0,
    ...
    //function m() {
    //    var a = e(".header-page__inner"), t = a.offset().top, i = e(window).scrollTop(), n = a.outerHeight(), o = t + n;
    //    a.data("scrollTop", i), e(window).scroll(function () {
    //        var i = e(window).scrollTop(), r = a.data("scrollTop");
    //        if (i > r) {
    //            if (a.hasClass("header-page__fixed")) {
    //                var s = a.data("y"), l = r - i, c = n > s + l ? s - l : n, d = "translateY(-" + c + "px)";
    //                a.css({
    //                    "-webkit-transform": d,
    //                    "-moz-transform": d,
    //                    "-ms-transform": d,
    ...
    //            var s = a.data("y"), l = r - i, c = s - l > 0 ? s - l : 0, d = "translateY(-" + c + "px)";
    //            a.css({
    //                "-webkit-transform": d,
    //                "-moz-transform": d,
    //                "-ms-transform": d,
    ...
    e.fn.imageCover = function () {
        e(this).each(function () {
            var a = e(this), t = a.find("img"), i = a.outerHeight(), n = (t.outerWidth(), t.outerHeight());
            i > n && t.css({height: "100%", width: "auto"})
        })
    }, e(window).on("load resize", function () {
        var a = e(".navigation").data("responsive"), t = window.innerWidth, i = window.innerHeight, n = e("#header-page").height();
