...
function view_price_khachsan($data)
{
    ...
    $ft->assign('TABLE-NAME','price_khachsan');
...
{
    return '<th>id</th><th>name</th><th>value</th><th>position</th>';
}
//
...
function showFrom($form,$ListKey=array())
{
    ...
    $str_from.='<p><label>value</label><input class="text-input small-input" type="text"  name="value" value="'.(($form!=false)?$form->value:'').'" /></p>';
