<!--[if IE 7]>
<body class="ie7 lt-ie8 lt-ie9 lt-ie10"><![endif]--><!--[if IE 8]>
        ...
        <div class="header-page__inner">
            <div class="container">
                ...
                <nav class="navigation awe-navigation" data-responsive="1200">
                    <ul class="menu-list">
                        <li class="menu-item-has-children current-menu-parent"><a href="index.html">Home</a>
                            <ul class="sub-menu">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item-has-children"><a href="destinations-trip.html">Detail (Dark)</a>
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="destinations-attraction-dark.html">Attraction in destination</a>
                                        </li>
                        ...
                        <li class="menu-item-has-children"><a href="#">Pages</a>
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item-has-children"><a href="login.html">Log In</a>
                                    <ul class="sub-menu">
                ...
                <div class="search-box"><span class="searchtoggle"><i class="awe-icon awe-icon-search"></i></span>
                    <form class="form-search">
                        <div class="form-item"><input type="text" value="Search &amp; hit enter"></div>
                    </form>
                </div>
                <a class="toggle-menu-responsive" href="#">
                    <div class="hamburger"><span class="item item-1"></span> <span class="item item-2"></span> <span
